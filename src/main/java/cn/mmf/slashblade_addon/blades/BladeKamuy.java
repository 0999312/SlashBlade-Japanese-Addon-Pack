...
public class BladeKamuy {
	...
	public void InitRecipes(PostInitEvent event){
		...
		SlashBlade.addRecipe(namebase, new RecipeAwakeBlade(new ResourceLocation(namebase), blade_base, reqblade_base, new Object[]{
		...
		SlashBlade.addRecipe(namewater, new RecipeAwakeBlade(new ResourceLocation(namewater), blade_water, reqblade, new Object[]{
				"S8S","4K6","S2S",
				'S', sphere,'K', reqblade,'8',"blockLapis",'4', Blocks.ICE,'6', Blocks.SNOW,'2', Items.WATER_BUCKET
		}));
		SlashBlade.addRecipe(namefire, new RecipeAwakeBlade(new ResourceLocation(namefire), blade_fire, reqblade, new Object[]{
				"S8S","4K6","S2S",
				'S', sphere,'K', reqblade,'8',"blockRedstone",'4',Items.FIRE_CHARGE,'6', Items.BLAZE_ROD,'2', Items.LAVA_BUCKET
		}));
		SlashBlade.addRecipe(namelightning, new RecipeAwakeBlade(new ResourceLocation(namelightning), blade_lightning, reqblade, new Object[]{
				"S8S","4K6","S2S",
