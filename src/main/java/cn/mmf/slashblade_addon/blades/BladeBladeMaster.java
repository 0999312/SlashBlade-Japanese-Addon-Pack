...
public class BladeBladeMaster {
	...
	public void InitRecipes(PostInitEvent event){
		...
		SlashBlade.addRecipe(namegreenmist, new RecipeAwakeBladeSJAP(new ResourceLocation("flammpfeil.slashblade",namegreenmist), SlashBlade.getCustomBlade(namegreenmist),reqblade_1, new Object[]{
		...
		SlashBlade.addRecipe(nameaquablaze, new RecipeAwakeBladeSJAP(new ResourceLocation("flammpfeil.slashblade",nameaquablaze), SlashBlade.getCustomBlade(nameaquablaze),reqblade_2, new Object[]{
		...
		SlashBlade.addRecipe(namemoonlightcherry, new RecipeAwakeBladeSJAP(new ResourceLocation("flammpfeil.slashblade",namemoonlightcherry), SlashBlade.getCustomBlade(namemoonlightcherry),reqblade_3, new Object[]{
